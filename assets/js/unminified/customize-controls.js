...
( function ( api, $ ) {
	...
	api.controlConstructor[ 'foodica-range' ] = api.Control.extend( {
		ready() {
			const control = this,
				$input = this.container.find( '.foodica-control-range-value' ),
				$slider = this.container.find( '.foodica-control-range' );
	...
	api.controlConstructor[ 'foodica-alpha-color-picker' ] = api.Control.extend({
		ready: function() {
			var control = this,
