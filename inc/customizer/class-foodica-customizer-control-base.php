<?php
/**
 * Foodica Lite: Customizer Control Base
 *
 ...
 * @since 1.2.3
 */
if ( ! class_exists( 'Foodica_Customizer_Control_Base' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class Foodica_Customizer_Control_Base {
		...
		public function __construct() {
			add_action( 'foodica/customize_register', array( $this, 'customize_controls_register_configs' ), 10, 2 );
		...
		public function enqueue_scripts() {
			wp_enqueue_style(
				'foodica-custom-control-style',
				foodica_get_assets_uri( 'custom-controls', 'css', 'inc/customizer/custom-controls/assets/' ),
				null,
			...
			wp_enqueue_style(
				'select-woo',
				FOODICA_THEME_URI . 'inc/customizer/custom-controls/typography/selectWoo.css',
				null,
				FOODICA_THEME_VERSION
			);
			...
			wp_enqueue_script(
				'foodica-custom-control-script',
				foodica_get_assets_uri( 'custom-controls', 'js', 'inc/customizer/custom-controls/assets/' ),
...
new Foodica_Customizer_Control_Base();
