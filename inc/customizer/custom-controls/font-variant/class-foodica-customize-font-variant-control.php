...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 * Variant control.
	 */
	class Foodica_Customize_Font_Variant_Control extends WP_Customize_Control {
		 ...
		 * @var string $type
		 */
		public $type = 'foodica-font-variant';
		...
		<select data-inherit="<?php echo esc_attr( $this->foodica_inherit ); ?>" <?php $this->link(); ?>  multiple data-name="{{ data.id }}"
		...
		>
			...
			?>
		<input class="foodica-font-variant-hidden-value" type="hidden" value="{{data.value}}">
		</select>
			<?php
		}
	}
