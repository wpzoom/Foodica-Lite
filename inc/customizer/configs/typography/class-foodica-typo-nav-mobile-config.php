 ...
 * @since 1.2.3
 */
class Foodica_Typo_Nav_Mobile_Config {
	/**
	 * Configurations
	 *
	...
	public static function config( $wp_customize ) {
		return array(
			'section' => array(
				'id'   => 'foodica_typography_section_nav_mobile',
				'args' => array(
					'title' => __( 'Main Menu Links (Mobile)', 'foodica' ),
					'panel' => 'foodica_typography_panel',
				),
			),
			'setting' => array(
				array(
					'id'   => 'mainmenu-mobile-font-family',
					'args' => array(
				...
				array(
					'id'   => 'mainmenu-mobile-font-variant',
					'args' => array(
						'transport'         => 'postMessage',
				...
				array(
					'id'   => 'mainmenu-mobile-font-weight',
					'args' => array(
						'default'           => '400',
						'transport'         => 'postMessage',
				...
				array(
					'id'   => 'mainmenu-mobile-text-transform',
					'args' => array(
						'default'           => '',
						'transport'         => 'postMessage',
			...
			'control' => array(
				array(
					...
					'args'         => array(
						...
						'section' => 'foodica_typography_section_nav_mobile',
						'connect' => 'mainmenu-mobile-font-weight',
						'variant' => 'mainmenu-mobile-font-variant',
					),
				),
				array(
					'id'           => 'mainmenu-mobile-font-variant',
					...
					'args'         => array(
						...
						'section'     => 'foodica_typography_section_nav_mobile',
						'connect'     => 'mainmenu-mobile-font-family',
					),
				),
				array(
					'id'           => 'mainmenu-mobile-font-size',
				...
				array(
					...
					'callable_choices' => array(
						...
						array( 'mainmenu-mobile-font-family', $wp_customize ),
					),
				),
				array(
					'id'   => 'mainmenu-mobile-text-transform',
