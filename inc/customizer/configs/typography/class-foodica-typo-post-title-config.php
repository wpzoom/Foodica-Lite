 ...
 * @since 1.2.3
 */
class Foodica_Typo_Post_Title_Config {
	/**
	 * Configurations
	 *
	...
	public static function config( $wp_customize ) {
		return array(
			'section' => array(
				'id'   => 'foodica_typography_section_post_title',
				'args' => array(
					'title' => __( 'Blog Posts Title', 'foodica' ),
					'panel' => 'foodica_typography_panel',
				),
			),
			'setting' => array(
				array(
					'id'   => 'blog-title-font-family',
					'args' => array(
			...
			'control' => array(
				array(
					...
					'args'         => array(
						...
						'section' => 'foodica_typography_section_post_title',
						'connect' => 'blog-title-font-weight',
						'variant' => 'blog-title-font-variant',
					),
				),
				array(
					'id'           => 'blog-title-font-variant',
					...
					'args'         => array(
						...
						'section'     => 'foodica_typography_section_post_title',
						'connect'     => 'blog-title-font-family',
					),
				),
				array(
					'id'           => 'blog-title-font-size',
				...
				array(
					...
					'callable_choices' => array(
						...
						array( 'blog-title-font-family', $wp_customize ),
					),
				),
				array(
					'id'   => 'blog-title-text-transform',
